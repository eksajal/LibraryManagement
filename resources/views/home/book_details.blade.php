                        ...
                        <div class="currently-market-item all msc">
                            <div class="item">
                                <div class="left-image">
                                    @if($book->featured == '0')
                                    <img class="book_details_image" src="book/{{ $book->book_img }}" alt=""> 
                                    @endif 
                                    @if($book->featured == '1')
                                    <img class="book_details_image" src="createImage/{{ $book->book_img }}" alt=""> 
                                    @endif                                 
                                </div>
                                <div class="right-content">
                                    ...
                                    <br>
                                    <span class="bid">
                                        Category: <strong>{{ $book->category->cat_title }}</strong>
                                    </span>
