<x-guest-layout>
    <x-authentication-card>
        <x-slot name="logo">
            <div style="border: 3px solid blue; border-top: none; border-right: none;">
                <h1 style="font-size: 30px; font-weight: bold;">Registration</h1>
            </div>
        </x-slot>

        <x-validation-errors class="mb-4" />

        <form style="border: 3px solid blue; padding: 10px; border-top: none; border-left: none;" method="POST" action="{{ route('register') }}">
            @csrf
